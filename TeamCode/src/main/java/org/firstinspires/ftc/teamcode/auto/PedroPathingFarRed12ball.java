...
@Autonomous
public class PedroPathingFarRed12ball extends OpMode{
    ...
    private final Pose shootPose = new Pose (87,15, Math.toRadians(68));

    private final Pose markPose = new Pose (135,36, Math.toRadians(0));
    private final Pose mark2Pose = new Pose (128.9031505250875,83.60793465577596, Math.toRadians(0));
    ...
    public void buildPaths(){
        ...
        driveShootPosMarkPos = follower.pathBuilder()
                .addPath(new BezierLine(
                        shootPose,
                        new Pose(96, markPose.getY(), markPose.getHeading())
                ))
        ...
        driveShootPosMark3Pos = follower.pathBuilder()
                ...
                .setLinearHeadingInterpolation(shootPose.getHeading(), mark2Pose.getHeading())
                .addPath(new BezierLine(shootPose, markPose))
                .setConstantHeadingInterpolation(mark2Pose.getHeading())
                .build();
        driveMark3PosShootPos = follower.pathBuilder()
                .addPath(new BezierLine(mark2Pose, shootPose))
                .setLinearHeadingInterpolation(mark2Pose.getHeading(), shootPose.getHeading())
                .build();
